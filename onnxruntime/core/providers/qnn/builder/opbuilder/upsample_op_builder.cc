...
const std::unordered_map<std::string, uint32_t> UpsampleOpBuilder::supported_modes = {
...
const OnnxAttrInfo<std::string> UpsampleOpBuilder::onnx_mode_attr = {"mode", "nearest"};
