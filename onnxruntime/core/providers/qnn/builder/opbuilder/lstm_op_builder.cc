...
class LSTMOpBuilder : public BaseOpBuilder {
 ...
 private:
  ...
  Status AddStridedSliceNode(QnnModelWrapper& qnn_model_wrapper,
                             const NodeUnit& node_unit,
...
Status LSTMOpBuilder::AddStridedSliceNode(QnnModelWrapper& qnn_model_wrapper,
                                          const NodeUnit& node_unit,
                                          const std::string& input_name,
                                          const std::string& output_name,
                                          const std::vector<uint32_t>& input_shape,
...
Status LSTMOpBuilder::AddUnidirectionLSTM(QnnModelWrapper& qnn_model_wrapper,
  ...
  // input W
  {
    ...
    for (size_t i = 0; i < 4; i++) {
      ...
      ORT_RETURN_IF_ERROR(AddStridedSliceNode(/*qnn_model_wrapper=*/qnn_model_wrapper,
                                              /*node_unit=*/node_unit,
