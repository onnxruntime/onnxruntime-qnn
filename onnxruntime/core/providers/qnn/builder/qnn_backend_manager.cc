...
Ort::Status QnnBackendManager::SetSustainedPerformance(uint32_t htp_power_config_client_id, qnn::HtpPerformanceMode performance_mode, uint32_t rpc_polling_time, uint32_t rpc_control_latency) {
  ...
  switch (graph_state_) {
    ...
    case GraphState::INIT_DONE: {
      ...
      htp_power_config_manager_.SetRelaxedPerfPowerConfig(init_done_htp_performance_cfg, htp_power_config_client_id, onnxruntime::qnn::DcvsState_t::DCVS_DEFAULT);
    ...
    case GraphState::TIMEOUT: {
      if (!timer_resource_.caller_busy_) {
        ...
        htp_power_config_manager_.SetRelaxedPerfPowerConfig(timeout_htp_performance_cfg, htp_power_config_client_id, onnxruntime::qnn::DcvsState_t::DCVS_DEFAULT);
...
Ort::Status QnnBackendManager::SetPerformance(uint32_t htp_power_config_client_id, qnn::HtpPerformanceMode performance_mode, uint32_t rpc_polling_time, uint32_t rpc_control_latency) {
  std::lock_guard<std::mutex> lk(perf_mutex_);
  Ort::Status status = Ort::Status();
  switch (graph_state_) {
    case GraphState::RUN_DONE:
    case GraphState::INIT_DONE:
      switch (performance_mode) {
        ...
        case qnn::HtpPerformanceMode::kHtpHighPerformance: {
          ...
          htp_power_config_manager_.SetRelaxedPerfPowerConfig(relaxed_htp_performance_cfg, htp_power_config_client_id, onnxruntime::qnn::DcvsState_t::DCVS_DEFAULT);
        ...
        case qnn::HtpPerformanceMode::kHtpExtremePowerSaver: {
          ...
          htp_power_config_manager_.SetExtremeLowPerfPowerConfig(extreme_power_saver_htp_performance_cfg, htp_power_config_client_id);
        ...
        case qnn::HtpPerformanceMode::kHtpPowerSaver: {
          ...
          htp_power_config_manager_.SetReleasedPerfPowerConfig(released_htp_performance_cfg, htp_power_config_client_id, onnxruntime::qnn::DcvsState_t::DCVS_DEFAULT);
