...
/// <summary>
/// Represents a fusion of a Gemm -> DQ -> Q -> Mul -> Reshape -> Add sequence.
...
class LPBQFusion : public IQnnNodeGroup {
 public:
  LPBQFusion(const NodeUnit& Scale_DQL_node_unit,
  ...
  ORT_DISALLOW_COPY_AND_ASSIGNMENT(LPBQFusion);
  ...
  std::string_view Type() const override { return "LPBQFusion"; }
