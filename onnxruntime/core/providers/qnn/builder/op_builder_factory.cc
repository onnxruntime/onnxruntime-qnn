...
OpBuilderRegistrations::OpBuilderRegistrations() {
  ...
  CreateNeuronOpBuilder("Relu", *this);
  ...
  CreateNeuronOpBuilder("Sigmoid", *this);
  CreateSimpleOpBuilder("Sign", *this);
  CreateSimpleOpBuilder("Sin", *this);
  CreateNeuronOpBuilder("Softplus", *this);
  ...
  CreateNeuronOpBuilder("Tanh", *this);
