...
struct ProfilingInfo {
  ...
  // UNKNOWN for provider-only profiling. Included in ORT JSON when the event is attached to an EP profiler.
  OrtProfilingOperation ort_profiling_operation = OrtProfilingOperation::UNKNOWN;
