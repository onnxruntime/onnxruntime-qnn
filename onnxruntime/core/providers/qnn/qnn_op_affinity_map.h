...
// execution is not supported (one backend per op). Consumed today only by GroupQueryAttention's
// IsOpSupported; the decision truth table (design spec) is encapsulated in Evaluate().
class OpAffinityMap {
 public:
