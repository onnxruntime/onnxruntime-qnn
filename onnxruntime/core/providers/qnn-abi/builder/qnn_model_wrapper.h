...
class QnnModelWrapper {
 ...
 public:
  QnnModelWrapper(const OrtGraph& ort_graph,
                  ...
                  std::unordered_map<std::string, std::string>* tensor_name_aliases = nullptr)
      : ort_graph_(ort_graph),
        ...
        tensor_name_aliases_(tensor_name_aliases) {
  }
  ...
  void SetTensorNameAlias(const std::string& tensor_name, const std::string& alias_name) const;
 ...
 private:
  ...
  const std::string* GetTensorNameAlias(const std::string& name) const;
  ...
  std::unordered_map<std::string, std::string>* tensor_name_aliases_ = nullptr;
};  // QnnModelWrapper
