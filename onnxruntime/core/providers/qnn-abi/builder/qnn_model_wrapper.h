...
class QnnModelWrapper {
 public:
  ...
  Ort::Status CreateQnnGraph(const Qnn_ContextHandle_t& context,
  ...
  Ort::Status ComposeQnnGraph(bool build_json_qnn_graph = false);
 ...
 private:
  Ort::Status CreateQnnInputOutputTensors(const std::string& qnn_node_name,
  ...
  Ort::Status CreateQnnParamTensors(const std::string& qnn_node_name,
