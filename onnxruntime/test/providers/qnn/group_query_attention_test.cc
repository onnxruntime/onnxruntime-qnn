...
static void RunGQATest(
  ...
  for (size_t i = 0; i < output_names.size(); i++) {
    VerifyOutput(output_names[i], cpu_outputs[i], *qnn_outputs[i], verification_params);
  }
}
...
// TODO: enable GQA tests once the EP upgrades to QAIRT 2.48
TEST_F(QnnGPUBackendTests, DISABLED_GroupQueryAttention_Basic_FP32) {
  // Test parameters
...
TEST_F(QnnGPUBackendTests, DISABLED_GroupQueryAttention_Basic_FP16) {
  // Test parameters
  const int32_t batch_size = 1;
  const int32_t sequence_length = 1;
  const int32_t total_seq_len = 1024;
...
TEST_F(QnnGPUBackendTests, DISABLED_GroupQueryAttention_Llama3_1_AR1_FP32) {
  // Test parameters
  const int32_t batch_size = 1;
  const int32_t sequence_length = 1;
  const int32_t total_seq_len = 1024;
...
TEST_F(QnnGPUBackendTests, DISABLED_GroupQueryAttention_Llama3_1_AR1_FP16) {
  // Test parameters
  const int32_t batch_size = 1;
  const int32_t sequence_length = 1;
  const int32_t total_seq_len = 1024;
...
TEST_F(QnnGPUBackendTests, DISABLED_GroupQueryAttention_Llama3_1_AR64_FP32) {
  // Test parameters
  const int32_t batch_size = 1;
...
TEST_F(QnnGPUBackendTests, DISABLED_GroupQueryAttention_Llama3_1_AR64_FP16) {
  // Test parameters
  const int32_t batch_size = 1;
  const int32_t sequence_length = 64;
  const int32_t total_seq_len = 1024;
...
TEST_F(QnnGPUBackendTests, DISABLED_GroupQueryAttention_Basic_SharedMemoryAllocator_FP32) {
  // Test parameters
  const int32_t batch_size = 1;
  const int32_t sequence_length = 1;
  const int32_t total_seq_len = 1024;
...
TEST_F(QnnGPUBackendTests, DISABLED_GroupQueryAttention_Basic_SharedMemoryAllocator_FP16) {
  // Test parameters
  const int32_t batch_size = 1;
  const int32_t sequence_length = 1;
  const int32_t total_seq_len = 1024;
...
TEST_F(QnnGPUBackendTests, DISABLED_GroupQueryAttention_Llama3_1_AR1_SharedMemoryAllocator_FP32) {
  // Test parameters
  const int32_t batch_size = 1;
  const int32_t sequence_length = 1;
  const int32_t total_seq_len = 1024;
...
TEST_F(QnnGPUBackendTests, DISABLED_GroupQueryAttention_Llama3_1_AR1_SharedMemoryAllocator_FP16) {
  // Test parameters
  const int32_t batch_size = 1;
  const int32_t sequence_length = 1;
  const int32_t total_seq_len = 1024;
...
TEST_F(QnnGPUBackendTests, DISABLED_GroupQueryAttention_Llama3_1_AR64_SharedMemoryAllocator_FP32) {
  // Test parameters
  const int32_t batch_size = 1;
  const int32_t sequence_length = 64;
  const int32_t total_seq_len = 1024;
...
TEST_F(QnnGPUBackendTests, DISABLED_GroupQueryAttention_Llama3_1_AR64_SharedMemoryAllocator_FP16) {
  // Test parameters
  const int32_t batch_size = 1;
  const int32_t sequence_length = 64;
  const int32_t total_seq_len = 1024;
