...
//
// No CPU-backend context is provided here. The snapshot/component infra currently
// targets HTP-backed coverage, so CPU backend setup is intentionally out of scope.
...
// header; CPU backend setup is intentionally out of scope for this infra.
//
// Usage:
