...
// (e.g. session_snapshot/ vs snapshot/) and by the `QnnSnapshot_*`
...
#include "test/providers/qnn/infra/snapshot_golden_utils.h"  // GetGoldenRootDir, NormalizeQnnJSONGraph, DeriveGoldenSubdirFromFile
