...
//
//   SnapshotTestContext       — stub-backed wrapper context (no live backend)
...
// FakeGraph / FakeNode / FakeValueInfo primitives — SnapshotTestContext uses a
...
// ---------------------------------------------------------------------------
// Default stubs for SnapshotTestContext
//
// Registered in the default constructor so any test using
// SnapshotTestContext can safely call FindInitializer / IsConstantInput
