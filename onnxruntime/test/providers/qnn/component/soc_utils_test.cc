...
TEST(QnnUnit_SocUtilsTest, MapSocModelFromSocName_SupportedChips) {
  EXPECT_EQ(qnn::soc::MapSocModelFromSocName("SM8350"), 30u);
  EXPECT_EQ(qnn::soc::MapSocModelFromSocName("SM8450"), 36u);
  ...
  EXPECT_EQ(qnn::soc::MapSocModelFromSocName("SM8850"), 87u);
}
