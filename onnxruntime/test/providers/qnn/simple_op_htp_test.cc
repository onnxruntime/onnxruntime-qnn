...
// Test ScatterND with reduction ADD op on HTP
...
// Test ScatterND with reduction Mul op on HTP
...
// Test ScatterND with reduction Max op on CPU Fallback
TEST_F(QnnHTPBackendTests, ScatterND_int64_int64_reduction_mul) {
  std::vector<int64_t> data = {0, 1, 2, 3};
  std::vector<int64_t> indices = {1};
  std::vector<int64_t> updates = {10};
...
// Test ScatterND with reduction Min op on CPU Fallback
TEST_F(QnnHTPBackendTests, ScatterND_int64_int64_reduction_mul) {
  std::vector<int64_t> data = {0, 1, 2, 3};
  std::vector<int64_t> indices = {1};
  std::vector<int64_t> updates = {10};
