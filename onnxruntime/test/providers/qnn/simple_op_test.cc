...
// -------------------------------------------------------------------------
// Selu tests (opsets 1, 6, 22 — float only, no QDQ variant)
// Decomposed into ElementwiseNeuron(ELU) + ElementwiseBinary(Multiply).
// -------------------------------------------------------------------------

// CPU FP32 — default alpha/gamma, opset 6.
TEST_F(QnnCPUBackendTests, UnaryOp_Selu_DefaultAttrs) {
  RunOpTestOnCPU("Selu",
                 {TestInputDef<float>({1, 2, 3}, false, GetFloatDataInRange(-10.0f, 10.0f, 6))},
                 {},
                 6,
...
// CPU FP32 — custom alpha and gamma, opset 6.
TEST_F(QnnCPUBackendTests, UnaryOp_Selu_CustomAttrs) {
  RunOpTestOnCPU("Selu",
                 {TestInputDef<float>({1, 2, 3}, false, GetFloatDataInRange(-10.0f, 10.0f, 6))},
...
// CPU FP32 — opset 1 (non-function op variant).
TEST_F(QnnCPUBackendTests, UnaryOp_Selu_Opset1) {
  RunOpTestOnCPU("Selu",
                 {TestInputDef<float>({1, 2, 3}, false, GetFloatDataInRange(-10.0f, 10.0f, 6))},
                 {},
                 1,
...
// CPU FP32 — opset 22 (adds bfloat16 to type constraints, float32 still valid).
TEST_F(QnnCPUBackendTests, UnaryOp_Selu_Opset22) {
  RunOpTestOnCPU("Selu",
                 {TestInputDef<float>({1, 2, 3}, false, GetFloatDataInRange(-10.0f, 10.0f, 6))},
                 {},
                 22,
...
// HTP FP32 — default attrs, opset 6.
TEST_F(QnnHTPBackendTests, UnaryOp_Selu_FP32_DefaultAttrs) {
  RunOpTest<float>("Selu",
                   {TestInputDef<float>({1, 2, 3}, false, GetFloatDataInRange(-10.0f, 10.0f, 6))},
                   {},
                   6,
                   ExpectedEPNodeAssignment::All);
...
// HTP FP32 — custom alpha and gamma, opset 6.
TEST_F(QnnHTPBackendTests, UnaryOp_Selu_FP32_CustomAttrs) {
  RunOpTest<float>("Selu",
                   {TestInputDef<float>({1, 2, 3}, false, GetFloatDataInRange(-10.0f, 10.0f, 6))},
                   {test::MakeAttribute("alpha", 1.0f),
                    test::MakeAttribute("gamma", 2.0f)},
...
// HTP FP32 via FP16 precision — default attrs.
TEST_F(QnnHTPBackendTests, UnaryOp_Selu_FP32_as_FP16) {
  RunOpTest<float>("Selu",
                   {TestInputDef<float>({1, 2, 3}, false, GetFloatDataInRange(-10.0f, 10.0f, 6))},
                   {},
                   6,
...
// HTP FP16 — default attrs.
TEST_F(QnnHTPBackendTests, UnaryOp_Selu_FP16) {
  RunFP16OpTest("Selu",
                {TestInputDef<float>({1, 2, 3}, false, GetFloatDataInRange(-10.0f, 10.0f, 6))},
                {},
                6,
