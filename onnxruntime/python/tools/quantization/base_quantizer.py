...
class BaseQuantizer:
    ...
    def check_opset_version(self):
        ...
        if opset_version < 10:
            ...
            self.replace_upsample_with_resize()
            opset_version = 11
    ...
    def replace_upsample_with_resize(self):
        new_nodes = []
        for node in self.model.model.graph.node:
            if node.op_type == "Upsample":
                ...
                scales_input = None
                if self.model.model.opset_import[0].version > 7:
                    ...
                    self.model.model.graph.initializer.append(scales_tensor)
                ...
                self.model.model.graph.initializer.append(roi_tensor)
        ...
        self.model.model.graph.node.extend(new_nodes)
