...
if(UNIX)
    if (CMAKE_SYSTEM_NAME STREQUAL "Linux")
        ...
        add_custom_command(
            ...
            ${Python_EXECUTABLE} ${onnxruntime_QNN_HOME}/bin/x86_64-linux-clang/qnn-op-package-generator -p ${TEST_SRC_DIR}/providers/qnn/udo/IncrementOpPackageHtp.xml
...
elseif(WIN32)
    ...
    add_custom_command(
        ...
        # generate op package
        COMMAND ${CMAKE_COMMAND} -E env PYTHONPATH=${onnxruntime_QNN_HOME}/lib/python
        ${Python_EXECUTABLE} ${onnxruntime_QNN_HOME}/bin/x86_64-windows-msvc/qnn-op-package-generator -p ${TEST_SRC_DIR}/providers/qnn/udo/IncrementOpPackageCpu.xml
