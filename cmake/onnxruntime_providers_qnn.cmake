...
# Licensed under the MIT License.
  ...
  target_link_libraries(onnxruntime_providers_qnn PRIVATE ${ONNXRUNTIME_PROVIDERS_SHARED} ${ABSEIL_LIBS} ${CMAKE_DL_LIBS} onnxruntime_common ${PROTOBUF_LIB} onnx_proto)

  # Link cpuinfo if supported - needed for CPU feature detection
  if (CPUINFO_SUPPORTED)
    onnxruntime_add_include_to_target(onnxruntime_providers_qnn cpuinfo::cpuinfo)
    target_link_libraries(onnxruntime_providers_qnn PRIVATE cpuinfo::cpuinfo ${ONNXRUNTIME_CLOG_TARGET_NAME})
  endif()

  add_dependencies(onnxruntime_providers_qnn onnxruntime_providers_shared onnx onnx_proto ${onnxruntime_EXTERNAL_DEPENDENCIES})
