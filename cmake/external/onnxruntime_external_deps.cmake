...
onnxruntime_fetchcontent_declare(
  ...
  PATCH_COMMAND
    ...
    ${Patch_EXECUTABLE} --binary --ignore-whitespace -p1 < ${CMAKE_CURRENT_SOURCE_DIR}/patches/ort_core/0006-perftest-QnnHtpShared-zerocopy-plugin-ep.patch &&
    ${Patch_EXECUTABLE} --binary --ignore-whitespace -p1 < ${CMAKE_CURRENT_SOURCE_DIR}/patches/ort_core/0008-deduplicate-autoep-custom-op-domains.patch # TODO: review on ORT core uplevel — see patch header
  EXCLUDE_FROM_ALL)
